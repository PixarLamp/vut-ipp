...
{
    if(preg_match("/^int@([\-+]?[0-9]+|0[xX][0-9a-fA-F]+|0[oO]?[0-7]+)$/", $nonterminal)) #symbol is constant (int)
    {
...
if ($argc > 1){
    if ($argv[1] == "--help"){
        ...
        echo("Skript typu filter (parse.php v jazyku PHP 7.4) nacita zo standardneho vstupu zdrojovy kod v IPPcode22,\n");
        ...
        echo("21 - chybna/chybajuca hlavicka v zdrojovom kode zapisanom v IPPcode22\n");
        echo("22 - neznamy/chybny operacny kod v zdrojovom kode zapisanom v IPPcode22\n");
        echo("23 - ina lexikalna/syntakticka chyba zdrojoveho kodu zapisaneho v IPPcode22\n");
        exit(0);
    }
    exit(10);
}
